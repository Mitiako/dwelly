...
const MapPage = () => {
  ...
  const topCities = [...citiesWithData].sort(
    (a, b) => b.data.saleData.averagePrice - a.data.saleData.averagePrice,
  );
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <p className="text-gray-400 text-xs">
          Interactive US real estate market map
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {(() => {
            const maxPrice = Math.max(
              ...citiesWithData.map((c) => c.data.saleData.averagePrice),
            );
                  ...
                  <div className="flex-1 h-1.5 bg-[#1a1a1a] rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor:
                          data.saleData.averagePrice > 800000
                            ? "#ef4444"
